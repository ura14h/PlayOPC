...
- (void)viewDidLoad {
	...
	self.showArtEffectTypeCellTitle = [camera cameraPropertyLocalizedTitle:CameraPropertyArtEffectHybrid];
	self.showArtEffectHybridCellTitle = [camera cameraPropertyLocalizedTitle:CameraPropertyArtEffectType];
