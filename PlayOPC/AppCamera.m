...
NSString *const CameraPropertyValueBatteryLevelUnknown = @"<BATTERY_LEVEL/UNKNOWN>";
NSString *const CameraPropertyValueBatteryLevelCharge = @"<BATTERY_LEVEL/CHARGE>";
NSString *const CameraPropertyValueBatteryLevelEmpty = @"<BATTERY_LEVEL/EMPTY>";
NSString *const CameraPropertyValueBatteryLevelWarning = @"<BATTERY_LEVEL/WARNING>";
NSString *const CameraPropertyValueBatteryLevelLow = @"<BATTERY_LEVEL/LOW>";
NSString *const CameraPropertyValueBatteryLevelFull = @"<BATTERY_LEVEL/FULL>";
NSString *const CameraPropertyValueBatteryLevelEmptyAc = @"<BATTERY_LEVEL/EMPTY_AC>";
NSString *const CameraPropertyValueBatteryLevelSupplyWarning = @"<BATTERY_LEVEL/SUPPLY_WARNING>";
NSString *const CameraPropertyValueBatteryLevelSupplyLow = @"<BATTERY_LEVEL/SUPPLY_LOW>";
NSString *const CameraPropertyValueBatteryLevelSupplyFull = @"<BATTERY_LEVEL/SUPPLY_FULL>";
...
NSString *const CameraPropertyLensPriorityAntiShake = @"LENS_PRIORITY_ANTI_SHAKE";
NSString *const CameraPropertyValueLensPriorityAntiShakeOff = @"<LENS_PRIORITY_ANTI_SHAKE/OFF>";
NSString *const CameraPropertyValueLensPriorityAntiShakeOn = @"<LENS_PRIORITY_ANTI_SHAKE/ON>";
...
- (NSArray *)listEnabledPropertiesForTakeMode:(NSString *)mode {
	...
	NSDictionary *enabledPropertiesByMode = @{
		CameraPropertyAperture: @[
				CameraPropertyValueTakemodeA,
				CameraPropertyValueTakemodeM,
				CameraPropertyValueExposeMovieSelectA,
				CameraPropertyValueExposeMovieSelectM,
			],
		CameraPropertyAe: @[
				CameraPropertyValueTakemodeP,
				CameraPropertyValueTakemodeA,
				CameraPropertyValueTakemodeS,
				CameraPropertyValueTakemodeM,
				CameraPropertyValueTakemodeArt,
			],
		CameraPropertyTakemode: @[
				CameraPropertyValueTakemodeIAuto,
				CameraPropertyValueTakemodeP,
				CameraPropertyValueTakemodeA,
				CameraPropertyValueTakemodeS,
				CameraPropertyValueTakemodeM,
				CameraPropertyValueTakemodeArt,
				CameraPropertyValueExposeMovieSelectP,
				CameraPropertyValueExposeMovieSelectA,
				CameraPropertyValueExposeMovieSelectS,
				CameraPropertyValueExposeMovieSelectM,
			],
		CameraPropertyIso: @[
				CameraPropertyValueTakemodeP,
